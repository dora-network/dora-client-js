...
> TradingChallengeRegistrationRequestResponseEnvelope approveTradingChallengeRegistrationRequest(requestId, opts)
...
let opts = {
  'reviewTradingChallengeRegistrationRequest': new Dora.ReviewTradingChallengeRegistrationRequest() // ReviewTradingChallengeRegistrationRequest | 
};
apiInstance.approveTradingChallengeRegistrationRequest(requestId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let closeAccountRequest = new Dora.CloseAccountRequest(); // CloseAccountRequest | 
apiInstance.closeIsolatedAccountV2(closeAccountRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getCopyTraders(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DepositInstructionsResponseEnvelope getDepositInstructions(quantity, ownerAddress, nonce, opts)
...
let apiInstance = new Dora.DefaultApi();
let quantity = "quantity_example"; // String | Human-decimal USDC quantity to deposit, e.g. '100.50'. Must be positive, with at most 6 decimal places.
let ownerAddress = "ownerAddress_example"; // String | The user's wallet address as a 0x-prefixed 20-byte hex string. Used as the permit owner.
let nonce = "nonce_example"; // String | The owner's current USDC permit nonce (read client-side), as a non-negative decimal string. It belongs to the single supported chain.
let opts = {
  'clientReferenceId': "clientReferenceId_example" // String | Optional client-supplied reference as a hex string (0x prefix optional), at most 32 bytes. Left-aligned into the deposit call's bytes32 argument.
};
apiInstance.getDepositInstructions(quantity, ownerAddress, nonce, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
apiInstance.getLedgerAccountsSelfV2((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let start = new Date("2013-10-20T19:20:30+01:00"); // Date | Start timestamp (inclusive) in RFC3339 format.
let end = new Date("2013-10-20T19:20:30+01:00"); // Date | End timestamp (exclusive) in RFC3339 format.
let opts = {
  'page': 1, // Number | 1-based page number for pagination.
  'limit': 100, // Number | Number of records per page (max 100). Defaults to 100.
  'all': false // Boolean | When true, includes users with allow_copy_trading=false. Requires admin role.
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **start** | **Date**| Start timestamp (inclusive) in RFC3339 format. | 
 **end** | **Date**| End timestamp (exclusive) in RFC3339 format. | 
 **page** | **Number**| 1-based page number for pagination. | [optional] [default to 1]
 **limit** | **Number**| Number of records per page (max 100). Defaults to 100. | [optional] [default to 100]
...
let opts = {
  ...
  'createdBefore': new Date("2013-10-20T19:20:30+01:00"), // Date | Filter settlements created before this time
  'settledAfter': new Date("2013-10-20T19:20:30+01:00"), // Date | Filter settlements settled after this time
 ...
 **createdBefore** | **Date**| Filter settlements created before this time | [optional] 
 **settledAfter** | **Date**| Filter settlements settled after this time | [optional] 
...
let apiInstance = new Dora.DefaultApi();
let userId = "userId_example"; // String | 
apiInstance.getUserDeactivation(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.leverageGetHistoricalInterestRates(assetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.leverageGetInterestRate(assetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
apiInstance.listAccountsSelfV2((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListDepositsResponseEnvelope listDeposits(opts)
...
apiInstance.listDeposits(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let opts = {
  'userId': "userId_example", // String | Filter by user ID (only allowed if the user has copy trading enabled, or if the requester is an Admin or Integrator within the same tenant)
...
> TradingChallengeRegistrationRequestListResponseEnvelope listTradingChallengeRegistrationRequests(opts)
...
let apiInstance = new Dora.DefaultApi();
let opts = {
  'tradingChallengeId': "tradingChallengeId_example", // String | Only requests for this challenge.
  'userId': "userId_example", // String | Only requests from this user.
  'status': "status_example", // String | Only requests in this state.
  'tenantId': "tenantId_example", // String | Admins only; an integrator may only name their own tenant.
  'limit': 100, // Number | Page size, capped at 1000.
  'offset': 0 // Number | Rows to skip.
};
apiInstance.listTradingChallengeRegistrationRequests(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **limit** | **Number**| Page size, capped at 1000. | [optional] [default to 100]
 **offset** | **Number**| Rows to skip. | [optional] [default to 0]
...
> UserDeactivationListResponseEnvelope listUserDeactivations(opts)
...
let apiInstance = new Dora.DefaultApi();
let opts = {
  'status': "status_example", // String | Only return users whose latest request has this status.
  'tenantId': "tenantId_example", // String | Only return users belonging to this tenant. At most one of tenant_id, trading_challenge_id and user_ids may be passed; combining them is rejected. An integrator whose tenant is not global may only pass their own tenant.
  'tradingChallengeId': "tradingChallengeId_example", // String | Only return participants of this trading challenge. Mutually exclusive with tenant_id and user_ids.
  'userIds': "userIds_example" // String | Comma-separated user IDs to return. Mutually exclusive with tenant_id and trading_challenge_id.
};
apiInstance.listUserDeactivations(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TradingChallengeRegistrationRequestResponseEnvelope rejectTradingChallengeRegistrationRequest(requestId, opts)
...
apiInstance.rejectTradingChallengeRegistrationRequest(requestId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let repayUSDRequest = new Dora.RepayUSDRequest(); // RepayUSDRequest | 
apiInstance.repayUSD(repayUSDRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let tradingChallengeId = "tradingChallengeId_example"; // String | 
apiInstance.terminateOwnTradingChallengeParticipation(tradingChallengeId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let tradingChallengeId = "tradingChallengeId_example"; // String | 
let userId = "userId_example"; // String | 
apiInstance.terminateTradingChallengeParticipation(tradingChallengeId, userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let transferAccountBalancesRequest = new Dora.TransferAccountBalancesRequest(); // TransferAccountBalancesRequest | 
apiInstance.transferAccountBalancesV2(transferAccountBalancesRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Dora.DefaultApi();
let tradingChallengeId = "tradingChallengeId_example"; // String | 
let updateTradingChallengeRequest = new Dora.UpdateTradingChallengeRequest(); // UpdateTradingChallengeRequest | 
apiInstance.updateTradingChallenge(tradingChallengeId, updateTradingChallengeRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
