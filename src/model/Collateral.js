...
class Collateral {
    ...
    constructor(positionId, transactionId, assetId, quantity) { 
        ...
        Collateral.initialize(this, positionId, transactionId, assetId, quantity);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Collateral</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Collateral</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Collateral.RequiredProperties) {
...
Collateral.RequiredProperties = ["position_id", "transaction_id", "asset_id", "quantity"];

/**
 * @member {String} position_id
 */
Collateral.prototype['position_id'] = undefined;

/**
 * @member {String} transaction_id
 */
Collateral.prototype['transaction_id'] = undefined;

/**
 * @member {String} asset_id
 */
Collateral.prototype['asset_id'] = undefined;
