...
class CreateAPIKeyResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        CreateAPIKeyResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAPIKeyResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAPIKeyResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAPIKeyResponseEnvelope.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          CreateAPIKeyData.validateJSON(data['data']);
        }
...
CreateAPIKeyResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
CreateAPIKeyResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
CreateAPIKeyResponseEnvelope.prototype['metadata'] = undefined;
...
export default CreateAPIKeyResponseEnvelope;
