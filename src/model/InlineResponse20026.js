 ...
 * @version 0.1.0
 */
export default class InlineResponse20026 extends ResponseEnvelope {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [TradeResponse]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/TradeResponse>} data
 */
