...
class IsolateCollateralResponse {
    ...
    constructor(metadata) { 
        ...
        IsolateCollateralResponse.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IsolateCollateralResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsolateCollateralResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsolateCollateralResponse.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          IsolatedCollateral.validateJSON(data['data']);
        }
...
IsolateCollateralResponse.RequiredProperties = ["metadata"];
...
export default IsolateCollateralResponse;
