...
class LedgerModuleResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        LedgerModuleResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LedgerModuleResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LedgerModuleResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LedgerModuleResponseEnvelope.RequiredProperties) {
...
LedgerModuleResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
LedgerModuleResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
LedgerModuleResponseEnvelope.prototype['metadata'] = undefined;
...
export default LedgerModuleResponseEnvelope;
