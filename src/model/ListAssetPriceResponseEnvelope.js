...
class ListAssetPriceResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        ListAssetPriceResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAssetPriceResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAssetPriceResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAssetPriceResponseEnvelope.RequiredProperties) {
...
ListAssetPriceResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
ListAssetPriceResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
ListAssetPriceResponseEnvelope.prototype['metadata'] = undefined;
...
export default ListAssetPriceResponseEnvelope;
