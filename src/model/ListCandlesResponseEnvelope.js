...
class ListCandlesResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        ListCandlesResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListCandlesResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCandlesResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListCandlesResponseEnvelope.RequiredProperties) {
...
ListCandlesResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
ListCandlesResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
ListCandlesResponseEnvelope.prototype['metadata'] = undefined;
...
export default ListCandlesResponseEnvelope;
