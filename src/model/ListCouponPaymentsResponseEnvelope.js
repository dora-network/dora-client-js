...
class ListCouponPaymentsResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        ListCouponPaymentsResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListCouponPaymentsResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCouponPaymentsResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListCouponPaymentsResponseEnvelope.RequiredProperties) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                CouponPayment.validateJSON(item);
            };
        }
...
ListCouponPaymentsResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
ListCouponPaymentsResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
ListCouponPaymentsResponseEnvelope.prototype['metadata'] = undefined;
...
export default ListCouponPaymentsResponseEnvelope;
