...
class OrderBookHaltResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        OrderBookHaltResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderBookHaltResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderBookHaltResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderBookHaltResponseEnvelope.RequiredProperties) {
...
OrderBookHaltResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
OrderBookHaltResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
OrderBookHaltResponseEnvelope.prototype['metadata'] = undefined;
...
export default OrderBookHaltResponseEnvelope;
