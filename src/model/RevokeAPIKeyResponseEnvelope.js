...
class RevokeAPIKeyResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        RevokeAPIKeyResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RevokeAPIKeyResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevokeAPIKeyResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RevokeAPIKeyResponseEnvelope.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          RevokeAPIKeyData.validateJSON(data['data']);
        }
...
RevokeAPIKeyResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
RevokeAPIKeyResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
RevokeAPIKeyResponseEnvelope.prototype['metadata'] = undefined;
...
export default RevokeAPIKeyResponseEnvelope;
