...
class TradeRequestError {
    ...
    constructor(metadata) { 
        ...
        TradeRequestError.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TradeRequestError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TradeRequestError</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TradeRequestError.RequiredProperties) {
...
TradeRequestError.RequiredProperties = ["metadata"];

/**
 * The response data. Present for successful (2xx) responses.
 * @member {Object} data
 */
TradeRequestError.prototype['data'] = undefined;
 ...
 */
TradeRequestError.prototype['metadata'] = undefined;
...
export default TradeRequestError;
