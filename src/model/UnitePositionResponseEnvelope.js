...
class UnitePositionResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        UnitePositionResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UnitePositionResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnitePositionResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UnitePositionResponseEnvelope.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          UnitedPosition.validateJSON(data['data']);
        }
...
UnitePositionResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
UnitePositionResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
UnitePositionResponseEnvelope.prototype['metadata'] = undefined;
...
export default UnitePositionResponseEnvelope;
