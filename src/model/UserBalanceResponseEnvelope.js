...
class UserBalanceResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        UserBalanceResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserBalanceResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserBalanceResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserBalanceResponseEnvelope.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          BalancesResponse.validateJSON(data['data']);
        }
...
UserBalanceResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
UserBalanceResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
UserBalanceResponseEnvelope.prototype['metadata'] = undefined;
...
export default UserBalanceResponseEnvelope;
