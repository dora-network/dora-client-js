...
class UserEnvelope {
    ...
    constructor(metadata) { 
        ...
        UserEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserEnvelope.RequiredProperties) {
...
UserEnvelope.RequiredProperties = ["metadata"];

/**
 * @member {module:model/User} data
 */
UserEnvelope.prototype['data'] = undefined;

/**
 * The error message. Present for error (non-2xx) responses.
 * @member {String} error
 */
UserEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
UserEnvelope.prototype['metadata'] = undefined;
