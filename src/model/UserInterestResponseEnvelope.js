...
class UserInterestResponseEnvelope {
    ...
    constructor(metadata) { 
        ...
        UserInterestResponseEnvelope.initialize(this, metadata);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserInterestResponseEnvelope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserInterestResponseEnvelope</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserInterestResponseEnvelope.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          UserInterest.validateJSON(data['data']);
        }
...
UserInterestResponseEnvelope.RequiredProperties = ["metadata"];
 ...
 * @member {String} error
 */
UserInterestResponseEnvelope.prototype['error'] = undefined;

/**
 * Metadata about the response, including status code and trace information.
 * @member {module:model/Metadata} metadata
 */
UserInterestResponseEnvelope.prototype['metadata'] = undefined;
...
export default UserInterestResponseEnvelope;
