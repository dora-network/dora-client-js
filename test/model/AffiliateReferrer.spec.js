...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dora.AffiliateReferrer();
  });
  ...
  describe('AffiliateReferrer', function() {
    it('should create an instance of AffiliateReferrer', function() {
      // uncomment below and update the code to test AffiliateReferrer
      //var instance = new Dora.AffiliateReferrer();
      //expect(instance).to.be.a(Dora.AffiliateReferrer);
    });
