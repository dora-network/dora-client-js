...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClaimLeverageAccruedInterestReq', function() {
      beforeEach(function() {
        instance = new Dora.ClaimLeverageAccruedInterestReq();
      });

      it('should create an instance of ClaimLeverageAccruedInterestReq', function() {
        // TODO: update the code to test ClaimLeverageAccruedInterestReq
        expect(instance).to.be.a(Dora.ClaimLeverageAccruedInterestReq);
      });
