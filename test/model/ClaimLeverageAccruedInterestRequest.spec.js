...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dora.ClaimLeverageAccruedInterestRequest();
  });
  ...
  describe('ClaimLeverageAccruedInterestRequest', function() {
    it('should create an instance of ClaimLeverageAccruedInterestRequest', function() {
      // uncomment below and update the code to test ClaimLeverageAccruedInterestRequest
