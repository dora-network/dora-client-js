...
(function(root, factory) {
  ...
  describe('Collateral', function() {
    it('should create an instance of Collateral', function() {
      // uncomment below and update the code to test Collateral
      //var instance = new Dora.Collateral();
      //expect(instance).to.be.a(Dora.Collateral);
    });
