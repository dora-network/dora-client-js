...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IsolateCollateralResponse', function() {
      beforeEach(function() {
        instance = new Dora.IsolateCollateralResponse();
      });

      it('should create an instance of IsolateCollateralResponse', function() {
        // TODO: update the code to test IsolateCollateralResponse
        expect(instance).to.be.a(Dora.IsolateCollateralResponse);
      });
