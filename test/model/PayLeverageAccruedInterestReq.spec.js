...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PayLeverageAccruedInterestReq', function() {
      beforeEach(function() {
        instance = new Dora.PayLeverageAccruedInterestReq();
      });

      it('should create an instance of PayLeverageAccruedInterestReq', function() {
        // TODO: update the code to test PayLeverageAccruedInterestReq
        expect(instance).to.be.a(Dora.PayLeverageAccruedInterestReq);
      });
