...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dora.PermitMessage();
  });
  ...
  describe('PermitMessage', function() {
    it('should create an instance of PermitMessage', function() {
      // uncomment below and update the code to test PermitMessage
      //var instance = new Dora.PermitMessage();
      //expect(instance).to.be.a(Dora.PermitMessage);
    });
