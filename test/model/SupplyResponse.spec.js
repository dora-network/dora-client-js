...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SupplyResponse', function() {
      beforeEach(function() {
        instance = new Dora.SupplyResponse();
      });

      it('should create an instance of SupplyResponse', function() {
        // TODO: update the code to test SupplyResponse
        expect(instance).to.be.a(Dora.SupplyResponse);
      });
