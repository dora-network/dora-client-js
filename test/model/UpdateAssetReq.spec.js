...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateAssetReq', function() {
      beforeEach(function() {
        instance = new Dora.UpdateAssetReq();
      });

      it('should create an instance of UpdateAssetReq', function() {
        // TODO: update the code to test UpdateAssetReq
        expect(instance).to.be.a(Dora.UpdateAssetReq);
      });
